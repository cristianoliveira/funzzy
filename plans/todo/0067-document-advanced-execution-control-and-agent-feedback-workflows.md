...
status: todo
depends_on: [TASK-0065, TASK-0028, TASK-0055, TASK-0059]
priority: high
...
- [ ] Control guide documents socket precedence, capabilities, status/list/run/emit/await/output/cancel, exact identity/freshness, timeout, exit codes, and bounded evidence.
